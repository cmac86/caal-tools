...
Manage TrueNAS system - check status including CPU, memory, storage pools, and apps, or control app start/stop/restart operations.
...
- `CAAL_ANNOUNCE_URL`: Your CAAL system announcement endpoint
